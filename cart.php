...
if(isset($_POST['order'])){
  ...
  $insert_query="insert into `userorder` (`amt`,`totalplants`,`odate`) values ('$amt','$totalplants','$odate')";
...
<form action="" method="post">
    ...
    <!--    <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="totalplants"
                 id="oid" class="form-control" 
                 placeholder="Enter order id" autocomplete="off"
                 required="required">
            </div>
