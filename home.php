...
<div class="row">
  <div class="col-md-10">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
        <div class="card">
  <img src="https://cdn.shopify.com/s/files/1/0047/9730/0847/products/nurserylive-g-plants-rose-dark-pink-plant-in-grower-round-black-pot-922015.jpg?v=1681378404" height="200px",weight="120px" class="card-img-top" alt="...">
  <div class="card-body">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Aloe is a cactus-like plant that grows in hot, dry climates. </p>
  ...
  <div class="card-body">
    ...
    <h5 class="card-title">Price:100</h5>
    <p class="card-text">chikoo leaves have a length of 0.8 to 3 cm.it is the fruit of an evergreen tree.
  </div></p>
