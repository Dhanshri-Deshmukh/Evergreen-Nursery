...
<div class="container-fluid p-0">
   ...
   <div class="bg-light">
    <h3 class="text-center p-2">EverGreen Nursery</h3>
</div>
      ...
      <div class="row">
        ...
        <div class="px-5">
            ...
            <div class="button text-center">
                ...
                <button><a href="http://localhost/nursery/udashboard.php/index.php?orderdetails" class="nav-link text-light bg-info my-1"> order Details</a></button>

                
               
                <button><a href="http://localhost/nursery/home.php?orders" class="nav-link text-light bg-info my-1">Logout</a></button>
